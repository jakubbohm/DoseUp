...
- UI-heavy changes get a **Claude Design mockup + handoff** before implementation ([conventions/design.md](docs/conventions/design.md) — the repo owns tokens/components; the design tool never writes to the repo).
