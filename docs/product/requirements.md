...
| NFR-6 | **Cost:** fits a hobby budget at circle scale — working target ≤ €20/month, outlook ≈ €0 after the reminder-trigger/transport decision ([ADR-0001-platform-and-stack](../adr/0001-platform-and-stack.md)) (OQ-1): Neon + ACA free grants, ASB Basic + Storage Queue ops in cents (2026-07), minimal compute footprint |
